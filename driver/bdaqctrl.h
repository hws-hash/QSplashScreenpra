...
typedef class  ScanChannel       ScanChannel;
typedef class  ConvertClock      ConvertClock;
typedef class  ScanClock         ScanClock;
typedef class  Trigger           Trigger;
typedef class  Conversion        Conversion;
typedef class  Record            Record;
typedef class  NosFltChannel     NosFltChannel;
typedef class  DeviceCtrl        DeviceCtrl;
typedef class  DaqCtrlBase       DaqCtrlBase;
              
typedef class  CjcSetting        CjcSetting;
typedef class  AiChannel         AiChannel;
typedef class  AiFeatures        AiFeatures;
typedef class  AiCtrlBase        AiCtrlBase;
typedef class  InstantAiCtrl     InstantAiCtrl;
typedef class  BufferedAiCtrl    BufferedAiCtrl;
typedef class  WaveformAiCtrl    WaveformAiCtrl;
                              
typedef class  AoChannel         AoChannel;
typedef class  AoFeatures        AoFeatures;
typedef class  AoCtrlBase        AoCtrlBase;
typedef class  InstantAoCtrl     InstantAoCtrl;
typedef class  BufferedAoCtrl    BufferedAoCtrl;
                              
typedef class  DioPort           DioPort;
typedef class  DiintChannel      DiintChannel;
typedef class  DiCosintPort      DiCosintPort;
typedef class  DiPmintPort       DiPmintPort;
typedef class  DioFeatures       DioFeatures;
typedef class  DioCtrlBase       DioCtrlBase;
typedef class  InstantDiCtrl     InstantDiCtrl;
typedef class  InstantDoCtrl     InstantDoCtrl;
                              
typedef class  CntrFeatures      CntrFeatures;
typedef class  CntrCtrlBase      CntrCtrlBase;
typedef class  EcChannel         EcChannel;
typedef class  EventCounterCtrl  EventCounterCtrl;
typedef class  FmChannel         FmChannel;
typedef class  FreqMeterCtrl     FreqMeterCtrl;
typedef class  OsChannel         OsChannel;
typedef class  OneShotCtrl       OneShotCtrl;
typedef class  TmrChannel        TmrChannel;
typedef class  TimerPulseCtrl    TimerPulseCtrl;
typedef class  PiChannel         PiChannel;
typedef class  PwMeterCtrl       PwMeterCtrl;
typedef class  PoChannel         PoChannel;
typedef class  PwModulatorCtrl   PwModulatorCtrl;
typedef class  UdChannel         UdChannel;
typedef class  UdCounterCtrl     UdCounterCtrl;
#endif
...
/*base2*/                                                                                                                                    
__inline ErrorCode         InstantAiCtrl_GetScaleTable(InstantAiCtrl *obj, int32 vrg, int32 *size, MapFuncPiece *table)                    { return DAQFN_ETTT (DNLAPI_AI, 53, int32, int32 *, MapFuncPiece *)(obj, vrg, size, table); }
__inline ErrorCode         InstantAiCtrl_SetScaleTable(InstantAiCtrl *obj, int32 vrg, int32 size, MapFuncPiece *table)                     { return DAQFN_ETTT (DNLAPI_AI, 54, int32, int32, MapFuncPiece *)(obj, vrg, size, table);   }
__inline ErrorCode         InstantAiCtrl_GenerateNewVrg(InstantAiCtrl *obj, int32 parent, int32 size, MapFuncPiece *table, int32 *child)   { return DAQFN_ETTTT(DNLAPI_AI, 55, int32, int32, MapFuncPiece *, int32 *)(obj, parent, size, table, child);}
...
/*base2*/                
__inline ErrorCode         BufferedAiCtrl_GetScaleTable(BufferedAiCtrl *obj, int32 vrg, int32 *size, MapFuncPiece *table)                  { return DAQFN_ETTT (DNLAPI_AI, 53, int32, int32 *, MapFuncPiece *)(obj, vrg, size, table); }
__inline ErrorCode         BufferedAiCtrl_SetScaleTable(BufferedAiCtrl *obj, int32 vrg, int32 size, MapFuncPiece *table)                   { return DAQFN_ETTT (DNLAPI_AI, 54, int32, int32, MapFuncPiece *)(obj, vrg, size, table);   }
__inline ErrorCode         BufferedAiCtrl_GenerateNewVrg(BufferedAiCtrl *obj, int32 parent, int32 size, MapFuncPiece *table, int32 *child) { return DAQFN_ETTTT(DNLAPI_AI, 55, int32, int32, MapFuncPiece *, int32 *)(obj, parent, size, table, child);}
...
/*base2*/                
__inline ErrorCode         WaveformAiCtrl_GetScaleTable(WaveformAiCtrl *obj, int32 vrg, int32 *size, MapFuncPiece *table)                  { return DAQFN_ETTT (DNLAPI_AI, 53, int32, int32 *, MapFuncPiece *)(obj, vrg, size, table); }
__inline ErrorCode         WaveformAiCtrl_SetScaleTable(WaveformAiCtrl *obj, int32 vrg, int32 size, MapFuncPiece *table)                   { return DAQFN_ETTT (DNLAPI_AI, 54, int32, int32, MapFuncPiece *)(obj, vrg, size, table);   }
__inline ErrorCode         WaveformAiCtrl_GenerateNewVrg(WaveformAiCtrl *obj, int32 parent, int32 size, MapFuncPiece *table, int32 *child) { return DAQFN_ETTTT(DNLAPI_AI, 55, int32, int32, MapFuncPiece *, int32 *)(obj, parent, size, table, child);}
...
/* base2*/                                                                                                                                    
__inline ErrorCode         InstantAoCtrl_GetScaleTable(InstantAoCtrl *obj, int32 vrg, int32 *size, MapFuncPiece *table)                    { return DAQFN_ETTT (DNLAPI_AO, 22, int32, int32 *, MapFuncPiece *)(obj, vrg, size, table);            }
__inline ErrorCode         InstantAoCtrl_SetScaleTable(InstantAoCtrl *obj, int32 vrg, int32 size, MapFuncPiece *table)                     { return DAQFN_ETTT (DNLAPI_AO, 23, int32, int32, MapFuncPiece *)(obj, vrg, size, table);             }
__inline ErrorCode         InstantAoCtrl_GenerateNewVrg(InstantAoCtrl *obj, int32 parent, int32 size, MapFuncPiece *table, int32 *child)   { return DAQFN_ETTTT(DNLAPI_AO, 24, int32, int32, MapFuncPiece *, int32 *)(obj, parent, size, table, child); }
...
/* base2*/                                                                                                                                  
__inline ErrorCode         BufferedAoCtrl_GetScaleTable(BufferedAoCtrl *obj, int32 vrg, int32 *size, MapFuncPiece *table)                  { return DAQFN_ETTT (DNLAPI_AO, 22, int32, int32 *, MapFuncPiece *)(obj, vrg, size, table);            }
__inline ErrorCode         BufferedAoCtrl_SetScaleTable(BufferedAoCtrl *obj, int32 vrg, int32 size, MapFuncPiece *table)                   { return DAQFN_ETTT (DNLAPI_AO, 23, int32, int32, MapFuncPiece *)(obj, vrg, size, table);             }
__inline ErrorCode         BufferedAoCtrl_GenerateNewVrg(BufferedAoCtrl *obj, int32 parent, int32 size, MapFuncPiece *table, int32 *child) { return DAQFN_ETTTT(DNLAPI_AO, 24, int32, int32, MapFuncPiece *, int32 *)(obj, parent, size, table, child); }
...
__inline DioPortDir        DioPort_getDirection(DioPort *obj)                                                                            { return DAQFN_TV(DNLAPI_DIO, 1, DioPortDir)(obj);        }
__inline ErrorCode         DioPort_setDirection(DioPort *obj, DioPortDir value)                                                          { return DAQFN_ET(DNLAPI_DIO, 2, DioPortDir)(obj, value); }
/*DI port property*/     
...
{
public:
   void  Dispose()                                          { return Array_Dispose((IArray *)this);              }   /*destroy the instance*/
...
public:
   ...
   ErrorCode GetScaleTable(int32 vrg, int32 &size, MapFuncPiece *table)                   { return DAQFN_ETTT (DNLAPI_AI, 53, int32, int32 *, MapFuncPiece *)(this, vrg, &size, table); }
   ErrorCode SetScaleTable(int32 vrg, int32  size, MapFuncPiece *table)                   { return DAQFN_ETTT (DNLAPI_AI, 54, int32, int32, MapFuncPiece *)(this, vrg, size, table);   }
   ErrorCode GenerateNewVrg(int32 parent, int32 size, MapFuncPiece *table, int32 &child)  { return DAQFN_ETTTT(DNLAPI_AI, 55, int32, int32, MapFuncPiece *, int32 *)(this, parent, size, table, &child);}
...
public:
   /*AI Control Common Method*/
   ErrorCode GetScaleTable(int32 vrg, int32 &size,    MapFuncPiece *table)                { return DAQFN_ETTT (DNLAPI_AO, 22, int32, int32 *, MapFuncPiece *)(this, vrg, &size, table); }
   ErrorCode SetScaleTable(int32 vrg, int32  size,    MapFuncPiece *table)                { return DAQFN_ETTT (DNLAPI_AO, 23, int32, int32, MapFuncPiece *)(this, vrg, size, table);   }
   ErrorCode GenerateNewVrg(int32 parent, int32 size, MapFuncPiece *table, int32 &child)  { return DAQFN_ETTTT(DNLAPI_AO, 24, int32, int32, MapFuncPiece *, int32 *)(this, parent, size, table, &child);}
...
public:
   ...
   DioPortDir getDirection()                                               { return DioPort_getDirection(this);            }
   ErrorCode  setDirection(DioPortDir value)                               { return DioPort_setDirection(this, value);     }
